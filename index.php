...
<div  id="ajaxResponse" class="w3-center">
	...
	<p class="w3-text-grey w3-small">CHNCXR_0216_0.png</p>
	<img src="tb_all_images/CHNCXR_0216_0.png" class="w3-round responsive" alt="chest x-ray image">
	
	<div>
		<h5 id="diagnosis" class="space-letters w3-text-blue w3-round" style="visibility:hidden"><b>0 - Normal</b></h5>
	</div>
</div>
...
<div class="w3-text-grey w3-center space-letters">
	...
	<p><span id="displayCount">1</span> of 800</p>
